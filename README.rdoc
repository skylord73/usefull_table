...
===Table
   ...
   options[:table][:header_type] = 
    *:sort*   #note: :human if @search not present (no sorting possible)
...
==Localization
Please note the the default locale for the gem is :it
if you want to change, modify the line:
  #config/application.rb
  config.i18n.default_locale = :en

rename and modify the config/locales from *.it.yml to *.en.yml
